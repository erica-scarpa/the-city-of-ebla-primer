...
\hypertarget{measures-and-numbers}{%
\chapter{Measures and Numbers}\label{measures-and-numbers}}

\hypertarget{capactities}{%
\section{Capactities}\label{capactities}}

At Ebla, the weight system used a Western mina of 470 grams, with a corresponding shekel of 7.83 grams. However, scribes working at the archives also employed other systems, such as the Levantine mina (1 mina = 50 shekels of 9.4 grams) and the Anatolian mina (1 mina = 40 shekels of 11.7 grams) (\protect\hyperlink{ref-Peyronel2006}{Peyronel, 2006, p. 267}; \protect\hyperlink{ref-Peyronel2016}{2016, p. 58}).
...
Archi, A. (2015). The {Tablets} of the {Throne Room} of the {Royal Palace G} of {Ebla}. \emph{Archiv Für Orientforschung}, \emph{53}, 9--18.
...
Bonechi, M. (2023). {TM}.75.{G}.5278 = {\emph{ARET}} {XII} 848 + {TM}.75.{G}.1985+{TM}.75.{G}.10188 = {\emph{ARET}} {XIV} 82, an {Ebla} {\emph{Téléjoint}}. \emph{Nouvelles Assyriologiques Brèves Et Utilitaires}, \emph{2023/3}, 8--10. \url{https://sepoa.fr/nabu-2023/}
...
Di Filippo, F., Maiocchi, M., Milano, L., \& Orsini, R. (2018). The {``{Ebla Digital Archives}''} {Project}: {How} to {Deal With Methodological} and {Operational Issues} in the {Development} of {Cuneiform Texts Repositories}. \emph{Archeologia e Calcolatori}, \emph{29}, 117--142. \url{http://www.archcalc.cnr.it/indice/PDF29/14_Di\%20Filippo_et_al.pdf}
...
\leavevmode\vadjust pre{\hypertarget{ref-Peyronel2016}{}}%
Peyronel, L. (2016). Tablets, {Sealings} and {Weights} at {Ebla}: {Administrative} and {Economic Procedures} at the beginning of the {Archaic State} in {Syria}. \emph{Archéo-Nil}, \emph{26}(1), 49--66. \url{https://doi.org/10.3406/arnil.2016.1103}
